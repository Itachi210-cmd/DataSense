...
function AnalysisTabContent() {
  ...
  const tab = (params?.tab as string) || "stats";
...
export default function AnalysisTabRoute() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-slate-400 text-xs">Loading analysis tool...</div>}>
      <AnalysisTabContent />
    </Suspense>
  );
}
