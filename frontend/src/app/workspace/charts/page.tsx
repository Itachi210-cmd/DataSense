...
import { FileSpreadsheet, Upload, BarChart3, Plus, ArrowLeft } from "lucide-react";

function ChartsDashboardContent() {
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto w-full">
        {!activeDataset ? (
          <div className="flex flex-col items-center justify-center min-h-[50vh] text-center p-8 rounded-2xl bg-slate-900/30 border border-slate-800/60 max-w-xl mx-auto my-12 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-slate-400">
                Please upload a CSV or Excel file or load a demo dataset to view and manage charts.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-800/80">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white text-xs font-semibold shadow-lg shadow-indigo-600/20 transition-all"
                >
            ...
            {/* Saved Charts Grid */}
            <SavedChartsList summary={activeDataset} />
          </div>
        )}
      </div>
    </div>
...
export default function ChartsDashboardPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-slate-400 text-xs">Loading charts...</div>}>
